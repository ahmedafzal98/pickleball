  ...
  return (
    <section className="w-full flex justify-center mt-[5%]">
      <div className="bg-[#B9E018] w-4/5 h-[333px] rounded-4xl flex flex-col justify-center items-center opacity-80">
        <span className="font-bold text-4xl">Subscribe to our newsletter</span>
        ...
        <div className="flex items-center justify-between md:w-3/5 xl:w-1/5 h-16 rounded-3xl bg-white p-2">
          ...
          <div className="bg-black h-12 w-[119px] rounded-3xl text-white flex justify-center items-center">
